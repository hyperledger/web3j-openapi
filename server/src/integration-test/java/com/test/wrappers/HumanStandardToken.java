 ...
 *
 * <p>Generated with web3j version 4.6.0.
 */
...
public class HumanStandardToken extends Contract {
    ...
    @Deprecated
    public static com.test.wrappers.HumanStandardToken load(String contractAddress, Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit) {
        return new com.test.wrappers.HumanStandardToken(contractAddress, web3j, credentials, gasPrice, gasLimit);
    }

    @Deprecated
    public static com.test.wrappers.HumanStandardToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit) {
        return new com.test.wrappers.HumanStandardToken(contractAddress, web3j, transactionManager, gasPrice, gasLimit);
    }

    public static com.test.wrappers.HumanStandardToken load(String contractAddress, Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider) {
        return new com.test.wrappers.HumanStandardToken(contractAddress, web3j, credentials, contractGasProvider);
    }

    public static com.test.wrappers.HumanStandardToken load(String contractAddress, Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider) {
        return new com.test.wrappers.HumanStandardToken(contractAddress, web3j, transactionManager, contractGasProvider);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(Web3j web3j, Credentials credentials, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        ...
        return deployRemoteCall(com.test.wrappers.HumanStandardToken.class, web3j, credentials, contractGasProvider, BINARY, encodedConstructor);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(Web3j web3j, TransactionManager transactionManager, ContractGasProvider contractGasProvider, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(_initialAmount), 
                ...
                new Uint8(_decimalUnits), 
                new Utf8String(_tokenSymbol)));
        return deployRemoteCall(com.test.wrappers.HumanStandardToken.class, web3j, transactionManager, contractGasProvider, BINARY, encodedConstructor);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(Web3j web3j, Credentials credentials, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(_initialAmount), 
                ...
                new Uint8(_decimalUnits), 
                new Utf8String(_tokenSymbol)));
        return deployRemoteCall(com.test.wrappers.HumanStandardToken.class, web3j, credentials, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
    ...
    public static RemoteCall<HumanStandardToken> deploy(Web3j web3j, TransactionManager transactionManager, BigInteger gasPrice, BigInteger gasLimit, BigInteger _initialAmount, String _tokenName, BigInteger _decimalUnits, String _tokenSymbol) {
        String encodedConstructor = FunctionEncoder.encodeConstructor(Arrays.<Type>asList(new Uint256(_initialAmount), 
                ...
                new Uint8(_decimalUnits), 
                new Utf8String(_tokenSymbol)));
        return deployRemoteCall(com.test.wrappers.HumanStandardToken.class, web3j, transactionManager, gasPrice, gasLimit, BINARY, encodedConstructor);
    }
